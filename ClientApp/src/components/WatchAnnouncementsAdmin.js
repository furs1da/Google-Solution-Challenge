...
class WatchAdminAnnouncements extends React.Component {
    ...
    componentDidMount() {
        userService.GetAllAnnouncementAdmin().then(announcements => this.setState({ announcements }));
    }
...
export { WatchAdminAnnouncements }; 